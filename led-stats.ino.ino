...
const char* ssid = "dika";              //--> Your wifi name or SSID.
const char* password = "abc sampai z";  //--> Your wifi password.
//----------------------------------------
...
String host_or_IPv4 = "http://192.168.214.159/";
...
void loop() {
  ...
  Serial.println();
  delay(000);  //--> GET Data at every 10 seconds. From the tests I did, when I used the 5 second delay, the connection was unstable.
}